//! historica-git's CI, as one program.
//!
...
/// test run: MSRV is a promise about who can *compile* historica-git, and the
...
fn usage() -> String {
    let mut out = String::from(
        "historica-git's CI, and its releases. Each job below is exactly what \
