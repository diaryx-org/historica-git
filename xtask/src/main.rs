//! historigit's CI, as one program.
//!
...
/// test run: MSRV is a promise about who can *compile* historigit, and the
...
fn usage() -> String {
    let mut out = String::from(
        "historigit's CI, and its releases. Each job below is exactly what the CI \
         workflow runs.\n\n\
